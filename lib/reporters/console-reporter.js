...
ConsoleReporter.prototype.testGeneratedTransaction = function(test, txnHash, optionalTxnObj) {
  this._addNewLineIfNeeded();
  console.log(this.prefix.info, 'test', this._quotedTitleOf(test), 'generated transaction', txnHash, this.commonFormatter.formatTxnObj(optionalTxnObj));
};
