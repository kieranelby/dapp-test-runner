...
ConsoleReporter.prototype.testGeneratedContractEvent = function(test, contractEvent) {
  this._addNewLineIfNeeded();
  console.log(this.prefix.info, 'test', this._quotedTitleOf(test), 'generated contract event', this.commonFormatter.formatContractEvent(contractEvent));
};
